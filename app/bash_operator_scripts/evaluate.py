...
# import sys
# import os
# # sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), "../../")))   # for local testing
# from app.training.evaluate_model import evaluate_candidate_model
...
#     print(result["candidate_run_id"])  # for xcom   
